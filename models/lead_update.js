...
//     // Add any other fields relevant to the lead update
//   },
//   {
//     sequelize,
...
// LeadUpdate.belongsTo(Lead_Detail, { foreignKey: 'LeadDetailId', as: 'LeadDetail' });

// Employee.hasMany(LeadUpdate, { foreignKey: 'AgentId', as: 'LeadUpdates' });
